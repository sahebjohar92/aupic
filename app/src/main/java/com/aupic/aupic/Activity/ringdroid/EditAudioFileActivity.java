package com.aupic.aupic.Activity.ringdroid;
...
import com.aupic.aupic.Graphics.MarkerView;
import com.aupic.aupic.Holder.Media.MediaAudioDto;
import com.aupic.aupic.Holder.Ringdroid.FileSaveDialog;
import com.aupic.aupic.Holder.Ringdroid.SamplePlayer;
import com.aupic.aupic.Holder.Ringdroid.SongMetaDataReader;
import com.aupic.aupic.Graphics.WaveformView;
import com.aupic.aupic.Holder.Sound.SoundFile;
 ...
 */
public class EditAudioFileActivity extends AupFragmentActivity implements MarkerView.MarkerListener,
        WaveformView.WaveformListener
{
    ...
    protected int getContentViewId() {
        return R.layout.audio_editor;
    }

    @Override
    protected int getTitleText() {
        return R.string.edit_audio;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFilename = intent.getStringExtra(IntentConstants.SELECTED_AUDIO).replaceFirst("file://", "").replaceAll("%20", " ");
        mSoundFile = null;
        mKeyDown = false;
    ...
    private void loadFromFile() {
        ...
        mProgressDialog = new ProgressDialog(EditAudioFileActivity.this);
        ...
        mLoadSoundFileThread = new Thread() {
            public void run() {
                ...
                if (mLoadingKeepGoing) {
                    ...
                    EditAudioFileActivity.this.finish();
                }
            }
        };
...
//        mFinishActivity = false;
//        AlertDialog.Builder adBuilder = new AlertDialog.Builder(EditAudioFile.this);
...
//        mRecordAudioThread.start();
    ...
    private void showFinalAlert(Exception e, CharSequence message) {
        ...
        new AlertDialog.Builder(EditAudioFileActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(
    ...
    private String makeRingtoneFilename(CharSequence title, String extension) {
        ...
        for (int i = 0; i < 100; i++) {
            String testPath;
            if (i > 0)
                testPath = storageDir + "/" + filename + i + extension;
            else
                testPath = storageDir + "/" + filename + extension;
    ...
    private void saveRingtone(final CharSequence title) {
        ...
        mSaveSoundFileThread = new Thread() {
            public void run() {
                ...
                String outPath = makeRingtoneFilename(title, StringConstants.AUDIO_EXTENSION);
                if (outPath == null) {
                    Runnable runnable = new Runnable() {
                        public void run() {
    ...
    private void afterSavingRingtone(CharSequence title, String outPath, int duration) {
        ...
        mediaAudioDto.setData(outPath);
        //mediaAudioDto.setTitle((String) title);
        mediaAudioDto.setDuration(duration * 1000);

        Intent mediaIntent = new Intent();
        mediaIntent.putExtra(IntentConstants.SELECTED_AUDIO, mediaAudioDto);
        setResult(RESULT_OK, mediaIntent);
