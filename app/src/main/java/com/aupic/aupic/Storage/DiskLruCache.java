...
import com.aupic.aupic.BuildConfig;
...
public class DiskLruCache {
    ...
    private long maxCacheByteSize = 1024 * 1024 * 30; // 30MB default
    ...
    public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize) {
        ...
        if (cacheDir.isDirectory() && cacheDir.canWrite()
                && StorageUtils.getUsableSpace(cacheDir) > maxByteSize) {
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath =
                Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED ||
                        ...
                        StorageUtils.getExternalCacheDir(context).getPath() :
    ...
    /**
     * Writes a bitmap to a file. Call {@link DiskLruCache#setCompressParams(Bitmap.CompressFormat, int)}
    ...
    private boolean writeBitmapToFile(Bitmap bitmap, String file)
        ...
        try {
            out = new BufferedOutputStream(new FileOutputStream(file), StorageUtils.IO_BUFFER_SIZE);
